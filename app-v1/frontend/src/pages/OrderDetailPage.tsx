  ...
  return (
    <div style={{ maxWidth: '800px', margin: '32px auto', padding: '0 16px' }}>
      ...
      <div style={cardStyle}>
        ...
        {/* Cost Breakdown */}
        <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '2px solid #e5e7eb', display: 'flex', flexDirection: 'column', gap: '8px', maxWidth: '240px', marginLeft: 'auto' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '17px', fontWeight: 700, color: '#111827', paddingTop: '8px', borderTop: '1px solid #e5e7eb' }}>
            <span>Total</span>
