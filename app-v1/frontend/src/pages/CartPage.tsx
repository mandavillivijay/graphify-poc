  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'flex-start' }}>
        ...
        {/* Order Summary */}
        <div style={{ flex: '0 0 260px', ...cardStyle, padding: '24px' }}>
          <h3 style={{ margin: '0 0 20px', fontSize: '18px', color: '#111827' }}>Order Summary</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '14px' }}>
            ...
            {shipping === 0 && subtotal > 0 && (
              <p style={{ fontSize: '12px', color: '#16a34a', margin: '0' }}>Free shipping on orders over $50!</p>
            )}
            <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '12px', display: 'flex', justifyContent: 'space-between', fontWeight: 700, fontSize: '17px', color: '#111827' }}>
              <span>Total</span>
          ...
          <button
            ...
            style={{ width: '100%', marginTop: '20px', padding: '13px', backgroundColor: '#4f46e5', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '16px', fontWeight: 600, cursor: 'pointer' }}
          >
            Proceed to Checkout
          </button>
