...
export class AuthenticationService {
  ...
  /**
   * Clicks the Logout button in the Navbar and waits for the redirect to /login.
  ...
  /**
   * Returns true when the Navbar shows a "Logout" button — indicating
   * the user is currently authenticated in the browser.
   */
